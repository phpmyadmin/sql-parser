...
class ContextMySql80300 extends Context
{
    ...
    public static array $keywords = [
        ...
        'INDEXES' => Token::FLAG_KEYWORD, 'INSTALL' => Token::FLAG_KEYWORD,
        ...
        'PARTIAL' => Token::FLAG_KEYWORD, 'PERSIST' => Token::FLAG_KEYWORD, 'PLUGINS' => Token::FLAG_KEYWORD, 'PREPARE' => Token::FLAG_KEYWORD, 'PROFILE' => Token::FLAG_KEYWORD,
        'REBUILD' => Token::FLAG_KEYWORD, 'RECOVER' => Token::FLAG_KEYWORD, 'RESTORE' => Token::FLAG_KEYWORD, 'RETURNS' => Token::FLAG_KEYWORD, 'ROUTINE' => Token::FLAG_KEYWORD,
        'SESSION' => Token::FLAG_KEYWORD, 'STACKED' => Token::FLAG_KEYWORD, 'STORAGE' => Token::FLAG_KEYWORD, 'SUBJECT' => Token::FLAG_KEYWORD, 'SUSPEND' => Token::FLAG_KEYWORD,
        'UNICODE' => Token::FLAG_KEYWORD, 'UNKNOWN' => Token::FLAG_KEYWORD, 'UPGRADE' => Token::FLAG_KEYWORD, 'USE_FRM' => Token::FLAG_KEYWORD, 'WITHOUT' => Token::FLAG_KEYWORD,
        ...
        'SECURITY' => Token::FLAG_KEYWORD, 'SHUTDOWN' => Token::FLAG_KEYWORD, 'SNAPSHOT' => Token::FLAG_KEYWORD, 'SWITCHES' => Token::FLAG_KEYWORD, 'TRIGGERS' => Token::FLAG_KEYWORD,
        'UNDOFILE' => Token::FLAG_KEYWORD, 'WARNINGS' => Token::FLAG_KEYWORD,
        ...
        'PERSIST_ONLY' => Token::FLAG_KEYWORD, 'RELAY_THREAD' => Token::FLAG_KEYWORD, 'SERIALIZABLE' => Token::FLAG_KEYWORD, 'SQL_NO_CACHE' => Token::FLAG_KEYWORD,
        'SQL_TSI_HOUR' => Token::FLAG_KEYWORD, 'SQL_TSI_WEEK' => Token::FLAG_KEYWORD, 'SQL_TSI_YEAR' => Token::FLAG_KEYWORD, 'SUBPARTITION' => Token::FLAG_KEYWORD,
        ...
        'NULL' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'OVER' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'READ' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'SHOW' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'THEN' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'TRUE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        'UNDO' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'WHEN' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'WITH' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        ...
        'DELETE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'ELSEIF' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'HAVING' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'IGNORE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'INFILE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        'LINEAR' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'OPTION' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'REGEXP' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'RENAME' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'RETURN' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        'REVOKE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'SELECT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'SIGNAL' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'STORED' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'UNLOCK' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        ...
        'CONDITION' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'DATABASES' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'GENERATED' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'PARTITION' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        'PRECISION' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'PROCEDURE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'SENSITIVE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED, 'SEPARATOR' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_RESERVED,
        ...
        'ISEMPTY' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'IS_IPV4' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'IS_IPV6' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'IS_UUID' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'QUARTER' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'RADIANS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'REVERSE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'SOUNDEX' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_AREA' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_SRID' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'SUBDATE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'SUBTIME' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'SYSDATE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'TOUCHES' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'TO_DAYS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'VAR_POP' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'VERSION' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'WEEKDAY' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        ...
        'AES_DECRYPT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'AES_ENCRYPT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'BIN_TO_UUID' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'CHAR_LENGTH' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'DATE_FORMAT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'DES_DECRYPT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'DES_ENCRYPT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'FIND_IN_SET' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'FROM_BASE64' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'GEOMFROMWKB' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'GTID_SUBSET' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'JSON_INSERT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'JSON_LENGTH' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'JSON_OBJECT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'JSON_PRETTY' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'JSON_REMOVE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'JSON_SEARCH' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'LINEFROMWKB' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'MBRCONTAINS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'MBRDISJOINT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'MBROVERLAPS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'MICROSECOND' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'PERIOD_DIFF' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'POLYFROMWKB' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'SEC_TO_TIME' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'STDDEV_SAMP' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'STR_TO_DATE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_ASBINARY' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'ST_CENTROID' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_CONTAINS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_DISJOINT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_DISTANCE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'ST_ENDPOINT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_ENVELOPE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_ISCLOSED' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_ISSIMPLE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'ST_OVERLAPS' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_SIMPLIFY' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'ST_VALIDATE' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'SYSTEM_USER' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
        'TIME_FORMAT' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'TIME_TO_SEC' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION, 'UUID_TO_BIN' => Token::FLAG_KEYWORD | Token::FLAG_KEYWORD_FUNCTION,
